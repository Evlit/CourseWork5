...
class BaseUnit(ABC):
    ...
    Базовый класс юнита
    """
    def __init__(self, name: str, unit_class: UnitClass, weapon_name: str, armor_name: str):
        """
        ...
        self.weapon = equipment.get_weapon(weapon_name)
        self.armor = equipment.get_armor(armor_name)
